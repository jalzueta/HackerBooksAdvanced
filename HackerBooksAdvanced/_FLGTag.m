...
// Make changes to FLGTag.m instead.
...
const struct FLGTagRelationships FLGTagRelationships = {
	.books = @"books",
};

@implementation FLGTagID
@end

@implementation _FLGTag
...
- (FLGTagID*)objectID {
	return (FLGTagID*)[super objectID];
}
